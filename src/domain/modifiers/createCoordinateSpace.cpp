...
void ablate::domain::modifiers::CreateCoordinateSpace::Modify(DM &dm) { DMPlexCreateCoordinateSpace(dm, degree, PETSC_TRUE, PETSC_TRUE) >> utilities::PetscUtilities::checkError; }
