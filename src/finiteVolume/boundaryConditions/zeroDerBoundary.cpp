...
//    PetscPrintf(PETSC_COMM_WORLD, "outletnumValues: %" PetscInt_FMT"\n", outletnumValues);
//    PetscPrintf(PETSC_COMM_WORLD, "domainnumValues: %" PetscInt_FMT"\n", domainnumValues);
...
//        PetscPrintf(PETSC_COMM_WORLD, "--> Label %s with value %" PetscInt_FMT" has %" PetscInt_FMT" points\n", "domain", domainvalues[v], ndomainPoints);
...
//    PetscPrintf(PETSC_COMM_WORLD, "domainCoordsSize: %" PetscInt_FMT"\n", domainCoordsSize);
//    PetscPrintf(PETSC_COMM_WORLD, "outletCoordsSize: %" PetscInt_FMT"\n", outletCoordsSize);
//    //print size of correspondingDomainCellID

//    PetscPrintf(PETSC_COMM_WORLD, "correspondingDomainCellID: \n");
//    for(PetscInt i=0; i<outletCoordsSize; i++){
//        PetscPrintf(PETSC_COMM_WORLD, "correspondingDomainCellID[%" PetscInt_FMT"]: %" PetscInt_FMT"\n", i, correspondingDomainCellID[i]);
//    }
...
void ablate::finiteVolume::boundaryConditions::ZeroDerBoundary::updateFunction(PetscReal time, const PetscReal *x, PetscScalar *vals, PetscInt point) {
    ...
    // PetscPrintf(PETSC_COMM_WORLD, "domainLabel value= %" PetscInt_FMT"\n", value);
