...
class NPhaseAllaireAdvectionOld : public Process {
   public:
   ...
   public:
    ...
    NPhaseAllaireAdvectionOld(std::shared_ptr<eos::EOS> eosNPhase, const std::shared_ptr<parameters::Parameters> &parameters,
                           std::shared_ptr<fluxCalculator::FluxCalculator> fluxCalculatorNStiff);
    ~NPhaseAllaireAdvectionOld();
