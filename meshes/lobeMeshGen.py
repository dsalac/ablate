...
beginRamp = convert_to_point((beginSlab, 0.0))
endRamp   = convert_to_point((beginSlab + slabHeight, slabHeight))
endSlab   = convert_to_point((beginSlab + slabHeight + slabLength, slabHeight))
upperRight = convert_to_point((beginSlab + slabHeight + slabLength, heightMultiplier*slabHeight))
...
define_boundary([[upperRight, endSlab]], "outlet", boundary_ids)
define_boundary([[upperRight, upperLeft]], "upper", boundary_ids)
